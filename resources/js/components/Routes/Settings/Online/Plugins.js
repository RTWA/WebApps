...
import { Button, PluginCard, Loader, PageWrapper, withWebApps } from 'webapps-react';
...
const Plugins = ({ plugins }) => {
    ...
    if (plugins.online === null) {
        return (
            <PageWrapper title="Choose a Plugin to install">
                <Button to="/settings/appsplugins" style="link" className="flex flex-auto -mt-4 -ml-4 mb-4 text-sm uppercase">
